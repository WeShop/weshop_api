...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README.rdoc", "lib/authentication.rb", "lib/user.rb"]
  s.files = ["README.rdoc", "Rakefile", "lib/authentication.rb", "lib/user.rb", "Manifest", "weshop_api.gemspec"]
